...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <!-- Añade clase 'active' dinámicamente si es necesario -->
                        </li>
                        <li class="nav-item">
    ...
    <main class="container mt-4">
        <!-- Usa el contenedor de Bootstrap y añade margen superior -->
        <!-- Aquí se insertará el contenido específico de cada página -->
        <?= $this->renderSection('content') ?>
    </main>

    <footer class="container mt-5 py-3 bg-light text-center">
        <?php if (uri_string() != ''): ?>
        <!-- Esto evita mostrar el logo en la página principal -->
